...
ChatSchema.pre('findOne', function (this: any, next: any) {
  this.populate(chatPopulateOptions)
  next()
})

ChatSchema.pre('find', function (this: any, next: any) {
  this.populate(chatPopulateOptions)
  next()
})

ChatSchema.pre('findOneAndUpdate', function (this: any, next: any) {
  this.populate(chatPopulateOptions)
  next()
})
